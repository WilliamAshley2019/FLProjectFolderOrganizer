2026-07-12 started to resolve the plugin detection code to attempt to read fl native plugins correct etc, more needs to be done but should hopefully be in place by the next major update to the source. Started to work on midi extraction. 
